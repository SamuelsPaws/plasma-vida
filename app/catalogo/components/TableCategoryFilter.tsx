  ...
  return (
    ...
    >
        <span className="
            ...
            after:h-0.5 after:w-full after:bg-sky-600 after:opacity-0 lg:hover:after:opacity-100 after:transition-opacity after:duration-200"
        >{text}</span>
